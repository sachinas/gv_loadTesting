...
public class ConcurrentApexError extends TestBase{
	    ...
	    public void verifyLonGRunningProcess() {  
	        ...
	        driver.findElement(By.id("username")).sendKeys("sachin.sankanagoudar@greatvines.com"); 
	        
	        driver.findElement(By.id("password")).clear();
	        driver.findElement(By.id("password")).sendKeys("bira@1234");  
